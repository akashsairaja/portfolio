  ...
  <section className="about ml-auto">
    <div className="container bg-white">
      <div className="section-title">
        <h2 className="ml-auto d-flex">About Me <span role="img" aria-label="smile">😊 </span></h2>
        <p> {config.profile.aboutme}</p>
      </div>
      <div className="row py-5">
        <div className="col-md-12"><h3> {config.profile.designation} </h3></div>
        ...
        {
          'resume' in config && config.resume !== '' && (
            <div className="col-lg-12 col-md-12 my-2">
              <div className="d-flex justify-content-start">
                <a href={config.resume as string} target="_blank" rel="noopener noreferrer">
